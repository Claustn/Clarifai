#Taken with love from  Brandon Olins Password State module https://github.com/devblackops/PasswordState/blob/master/Tests/
$moduleName = 'PSClarifai'
...
Describe 'Module manifest' {
    Context 'Validation' {
        ...
        It "has a valid name in the manifest" {
            $script:manifest.Name | Should Be 'PSClarifai'
        }
